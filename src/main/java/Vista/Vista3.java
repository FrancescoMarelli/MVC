...
public class Vista3 extends JFrame implements Vista {
    ...
    private JPanel crearPanelPrincipal(String tituloPagina) {
        ...
        panelCabecera.setBackground(new Color(255, 0, 0)); // Cambiado a Rojo
    ...
    private JPanel crearPanelCabecera(String tituloPagina) {
        ...
        labelCabecera.setFont(new Font("Times New Roman", Font.ITALIC, 30)); // Cambiado a Times New Roman y tamaño 30
        labelCabecera.setForeground(Color.BLACK); // Texto negro
    ...
    private JPanel crearPanelNoticias(ArrayList<Article> articulos) {
        ...
        for (Article noticia : articulos) {
            ...
            panelNoticias.add(Box.createRigidArea(new Dimension(10, 15))); // Aumentado el espacio
        }
    ...
    private JPanel crearPanelTituloNoticia(Article noticia) {
        ...
        panelTituloNoticia.setBackground(new Color(128, 128, 128)); // Gris
        panelTituloNoticia.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 0), 2)); // Borde negro
        ...
        panelTituloNoticia.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                panelTituloNoticia.setBackground(new Color(192, 192, 192)); // Gris más claro al pasar el ratón
            }

            @Override
            public void mouseExited(MouseEvent e) {
                panelTituloNoticia.setBackground(new Color(128, 128, 128)); // Gris al salir del ratón
            }
        });
